...
**Author:** Test User  
**Contact:** diwa.vre.user@gmail.com
**Organization:** University of Oulu
**Website:** https://github.com/diwa-vre-user/another_test_project
...
```bibtex
@software another_test_project,
  author = Test User,
  title = Test Project,
  year = 2026,
  version = 0.1.0,
  doi = ,
  url = https://github.com/diwa-vre-user/another_test_project
}
```
or
